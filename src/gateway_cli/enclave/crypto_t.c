...
// for secure ferry simulation
//int ecall_veri_dec(uint8_t *src, int src_len, uint8_t *dst, const uint8_t *mac) {
//	return veri_dec(src, src_len, dst, (sgx_aes_gcm_128bit_tag_t *)mac);
//}
