...
/* Config for LightBox Networking */
//volatile short LBN_RECORD_SIZE = 0;
//volatile int LBN_RECORD_PER_BATCH = 0;
//volatile int LBN_BATCH_SIZE = 0;

/* Config for LightBox State Management */
#define FLOW_STATE_SIZE 440
