...
#include "../prads_enclave/cuckoo/cuckoo_hash.h"
#include <stdint.h>
#include <time.h>

#define TIME_ELAPSED_IN_US(s_sec, s_ns, e_sec, e_ns) ((e_sec-s_sec)*1000000.0 + (e_ns-s_ns)/1000.0)
#define TIME_ELAPSED_IN_NS(s_sec, s_ns, e_sec, e_ns) ((e_sec-s_sec)*1000000000.0 + (e_ns-s_ns))
